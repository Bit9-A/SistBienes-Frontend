                  ...
                  <Menu placement="bottom-end" isLazy>
                    ...
                    >
                      <MenuItem
                        ...
                        color={
                          selectedDept === 'all' ? 'type.primary' : 'inherit'
                        }
                      >
                      ...
                      {departments.map((dept) => (
                        <MenuItem
                          ...
                          fontWeight={
                            selectedDept === dept.id ? 'bold' : 'normal'
                          }
                          color={
                        ...
                        >
                          ...
                          <Td display={{ base: 'none', md: 'table-cell' }}>
                            <Text fontSize={{ base: 'sm', md: 'md' }}>
                              {departments.find(
                                (dept) =>
                                  String(dept.id) === String(user.dept_id),
                              )?.nombre || 'N/A'}
                            </Text>
                          </Td>
                          <Td display={{ base: 'none', lg: 'table-cell' }}>
                    ...
                    {Array.from({ length: Math.min(totalPages, 5) }, (_, i) => {
                      ...
                      return (
                        <Button
                          ...
                          color="white"
                          colorScheme={
                            page === currentPage ? 'purple' : 'purple'
                          }
                          ...
                          mx={0.5}
                          display={{
                            base: page === currentPage ? 'flex' : 'none',
                            md: 'flex',
                          }}
                        >
                          {page}
