...
interface ExportQRLabelsModalProps {
  isOpen: boolean;
  onClose: () => void;
...
export const ExportQRLabelsModal: React.FC<ExportQRLabelsModalProps> = ({
  isOpen,
  onClose,
  departments,
  onExport,
  ...
  return (
    <Modal isOpen={isOpen} onClose={onClose}>
      <ModalOverlay />
      <ModalContent>
        <ModalHeader>Exportar Etiquetas QR por Departamento</ModalHeader>
        <ModalCloseButton />
        <ModalBody>
          <FormControl>
